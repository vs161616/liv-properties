    ...
    <>
      <Fullpage>
        <FullPageSections>
                ...
                <Row>
                  <Col lg={4}>
                    <div className="ServiceBox pe-5">
                      <h4>Sales</h4>
                      <p className="m-0">
                        Liv Squared team of professional agents boast a
          ...
          <FullpageSection style={{ height: "65vh" }}>
                ...
                <Row>
                  <Col lg={5}>
                    <div className="footone">
                      ...
                      <h5>
                        Sign up for our newsletter to stay updated <br></br>{" "}
                        with what's new in UAE real estate
                      </h5>
                    </div>
                    <div className="mt-4">
                      <form>
